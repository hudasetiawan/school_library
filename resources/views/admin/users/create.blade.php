<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-foreground tracking-tight">Tambah Pengguna</h1>
                <p class="text-sm text-muted-foreground mt-0.5">Buat akun baru untuk siswa atau admin.</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="p-6 space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <x-text-input id="nomor_induk" name="nomor_induk" type="text" :value="old('nomor_induk')" required
                                      class="block w-full rounded-xl border-border bg-muted focus:border-ring focus:ring-ring/20 py-3" placeholder="Contoh: 12345" />
                    ...
                    <div>
                        ...
                        <x-text-input id="name" name="name" type="text" :value="old('name')" required
                                      class="block w-full rounded-xl border-border bg-muted focus:border-ring focus:ring-ring/20 py-3" placeholder="Nama Lengkap" />
                ...
                <div>
                    ...
                    <x-text-input id="email" name="email" type="email" :value="old('email')" required
                                  class="block w-full rounded-xl border-border bg-muted focus:border-ring focus:ring-ring/20 py-3" placeholder="nama@email.com" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <x-input-label for="password" :value="__('Password')" class="text-xs font-bold uppercase tracking-wider text-muted-foreground mb-1.5" />
                        <x-text-input id="password" name="password" type="password" required
                                      class="block w-full rounded-xl border-border bg-muted focus:border-ring focus:ring-ring/20 py-3" placeholder="Minimal 8 karakter" />
                    ...
                    <div>
                        ...
                        <x-text-input id="password_confirmation" name="password_confirmation" type="password" required
                                      class="block w-full rounded-xl border-border bg-muted focus:border-ring focus:ring-ring/20 py-3" placeholder="Ulangi password" />
