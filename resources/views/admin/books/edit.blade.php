        ...
        <div class="bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
            <form action="{{ route('admin.books.update', $book) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="px-6 md:px-8 py-4 bg-muted/80 border-t border-border flex items-center justify-between">
                    ...
                    <button type="submit"
                            class="inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-white px-6 py-2.5 rounded-xl text-sm font-semibold cursor-pointer transition-all duration-200 shadow-sm hover:shadow-md">
