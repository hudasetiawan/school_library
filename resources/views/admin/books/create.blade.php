<x-app-layout>
    <x-slot name="title">Tambah Buku Baru</x-slot>

    <div class="space-y-6" x-data="bookForm()">
        {{-- Page Header --}}
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-foreground tracking-tight">Tambah Buku Baru</h1>
                <p class="text-sm text-muted-foreground mt-0.5">Isi informasi buku untuk ditambahkan ke koleksi perpustakaan.</p>
            </div>
        </div>
        ...
        <div class="bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
            <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="text" id="kode_rak" name="kode_rak" value="{{ old('kode_rak') }}" required
                                       class="w-full px-4 py-2.5 bg-muted border border-border rounded-xl text-sm focus:ring-2 focus:ring-ring/20 focus:border-ring focus:bg-card transition-all placeholder:text-muted-foreground"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="number" id="total_eksemplar" name="total_eksemplar" value="{{ old('total_eksemplar', 0) }}" required min="0"
                                       class="w-full px-4 py-2.5 bg-muted border border-border rounded-xl text-sm focus:ring-2 focus:ring-ring/20 focus:border-ring focus:bg-card transition-all placeholder:text-muted-foreground"
                                       placeholder="0">
                                <p class="text-xs text-muted-foreground mt-1.5">Stok tersedia akan otomatis disamakan dengan total eksemplar.</p>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1">
                                        <label for="cover_image"
                                            ...
                                            <span class="text-xs text-muted-foreground font-medium">Pilih gambar</span>
                ...
                <div class="px-6 md:px-8 py-4 bg-muted/80 border-t border-border flex items-center justify-between">
                    ...
                    <button type="submit"
                            class="inline-flex items-center gap-2 cursor-pointer bg-primary text-background px-6 py-2.5 rounded-xl text-sm font-semibold hover:bg-primary/90 transition-all duration-200 shadow-sm hover:shadow-md">
